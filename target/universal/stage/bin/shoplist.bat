@REM shoplist launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SHOPLIST_config.txt found in the SHOPLIST_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%SHOPLIST_HOME%"=="" set "SHOPLIST_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%SHOPLIST_HOME%\lib\"
...
set "CFG_FILE=%SHOPLIST_HOME%\SHOPLIST_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running shoplist.
  echo.
