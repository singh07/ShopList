...
public class ProductController extends Controller {
	...
	public static Result addProduct() {
		...
		return ok(views.html.product.addProduct.render(productFormData,
				category, shop.owner.id));
	}
	...
	public static Result save() {
		...
		if (productFormData.hasErrors()) {
			...
			List<Product> prod = Product.findbyemail(shop.id);
			return badRequest(views.html.product.add.render(Product.all(),
					productFormData, category, prod, shop.owner.id));
	...
	public static Result showProducts(Long id) {
		...
		return ok(views.html.product.showProducts.render(products, shop.name,
				id));
	...
	/*
	 * public static Result afterDeletion() { String
	 * category=session("category"); List<Product> prod=
	 * Product.findbyemail(session("email")); return
	 * ok(views.html.product.add.render(Product.all(),
	 * productForm,category,prod));
	 * 
	 * }
	 */
