...
public class ShopController extends Controller {
	...
	public static Result viewAll(int page, String sortBy, String order,
			String filter) {

		return ok(views.html.shop.viewall.render(
				Shop.page(page, 4, sortBy, order, filter), sortBy, order,
				filter));
	...
	public static Result profile(Long id) {
		...
		return ok(views.html.shop.profile.render(shops_on_email,
				product_on_email));
	}
	...
	public static Result edit(Long id) {
		Form<Shop> shopForm = Form.form(Shop.class).fill(Shop.findbyid(id));
		String loggedInUserEmail = session("email");
		return ok(views.html.shop.edit.render(id, shopForm, loggedInUserEmail));
	}
	...
	public static Result update(Long id) {
		...
		if (shopForm.hasErrors()) {
			return badRequest(views.html.shop.edit.render(id, shopForm,
					loggedInUserEmail));
		}
		...
		// return
		// redirect(views.html.shop.profile.render(shops_on_id,product_on_id,id
		// ));
	}
	...
	public static Result submit() {
		...
		if (filledForm.hasErrors()) {
			...
			for (String key : filledForm.errors().keySet()) {
				List<ValidationError> currentError = filledForm.errors().get(
						key);
