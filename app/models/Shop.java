...
public class Shop extends Model {
	...
	public static Model.Finder<Long, Shop> find = new Model.Finder(Long.class,
			Shop.class);
	...
	public static List<Shop> findShopsByProduct(String product) {
		return Ebean.find(Shop.class)
				.fetch("products", new FetchConfig().query()).where()
				.eq("products.name", product).findList();
	}
	...
	/*
	 * public statc List<Product> productOnShop(Shop shop) { List <Product> }
	 */

	public static Page<Shop> page(int page, int pageSize, String sortBy,
